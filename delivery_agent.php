<?php
  ...
  $id = autoID("delivery_agent","D_ID","D_",10,"D_0000000001");
  $name = "";
  $address = "";
  $phone = "";
  $email = "";
  ...
  if(isset($_REQUEST['btn_save']))
  {
    ...
    $address = $_REQUEST['d_address'];
    $phone = $_REQUEST['d_phone'];
    ...
    else
    {
      ...
      $query = "INSERT INTO delivery_agent VALUE('$id', '$name','$address','$phone','$email')";
  ...
  if(isset($_REQUEST['btn_update']))
  {
    ...
    $query = "UPDATE delivery_agent SET D_NAME='$name', D_ADDRESS='$address', D_PHONE='$phone', D_EMAIL='$email'
              WHERE D_ID='$id'";
  ...
  if(isset($_REQUEST['edit']))
  {
    ...
    $query = "SELECT * FROM delivery_agent WHERE D_ID='$editid'";
  ...
  if(isset($_REQUEST['delete']))
  {
    ...
    $query = "DELETE FROM delivery_agent WHERE D_ID='$deleteid'";
    mysqli_query($connect,$query);
  }
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="div-form">
      <form action="delivery_agent.php" method="post" class="form">
        <table class="table_form">
          ...
          <tr>
            <td> ID </td>
            <td><input type="text" class="input_text" name="d_id" placeholder="ID" value="<?php echo $id; ?>" readonly/></td>
          </tr>
          <tr>
            <td> Name </td>
            <td><input type="text" class="input_text" name="d_name" placeholder="Name" value="<?php echo $name; ?>"/></td>
          </tr>
          <tr>
            <td> Address </td>
            <td><textarea name="d_address" rows="5" cols="23" placeholder="Address" value="<?php echo $address; ?>"></textarea></td>
          </tr>
          <tr>
            <td> Phone </td>
            <td><input type="text" class="input_text" name="d_phone" placeholder="Phone" value="<?php echo $phone ?>"/></td>
          </tr>
          <tr>
            <td> Email </td>
            <td><input type="text" class="input_text" name="d_email" placeholder="Email" value="<?php echo $email; ?>"/></td>
          </tr>
        </table>
        <div class="button">
          ...
          echo "<table border='1' class='database'>";
            ...
            while($data=mysqli_fetch_array($result))
            {
              echo "<tr class='edit_delete'>";
                ...
                echo "<td>" . $data[3] . "</td>";
                echo "<td>" . $data[4] . "</td>";
                echo '<td class="edit"><img src="./image/edit_icon.png" width="20px"/><a href="delivery_agent.php?edit='.$data[0].'">Edit</a></td>';
                echo '<td class="delete"><img src="./image/remove_icon.png" width="20px"/><a href="delivery_agent.php?delete='.$data[0].'">Delete</a></td>';
            }
            echo "</tr>";
          echo "</table>";
        echo "</div>";
